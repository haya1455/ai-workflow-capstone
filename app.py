...
from src.config import DATA_DIR, LOG_DIR, MODEL_DIR, MODEL_VERSION, MODEL_VERSION_NOTE
...
def train():
    ...
    train_data_path = os.path.join(DATA_DIR, 'cs-train')
    model_train(train_data_path ,test=test)
